...
-- Version 2: Safe DROP and CREATE

-- Drop tables if they exist (to allow re-running migration)
...
-- Enable RLS policies (Supabase default is enabled, we disable for MVP)
