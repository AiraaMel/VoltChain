...
export function AnchorTestPanel() {
  const {
    publicKey,
    isPhantomAvailable,
    isConnecting,
  ...
  const testRegisterUser = async () => {
    ...
    if (!userPubkey) throw new Error("Não foi possível obter PublicKey");
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6">
      <div className="space-y-4">
        ...
        {!isConnected && isPhantomAvailable && (
          <Button
